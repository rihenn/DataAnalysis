...
var dataTable = $('#PlatformTypeDatatable').DataTable({
    ajax: {
        url: '../DataGetPlatformType.php',
...
$('#PlatformTypeDatatable tbody').on('dblclick', 'tr', function () {
    var data = dataTable.row(this).data(); // Satır verilerini alın
    $('#PlatformCode').val(data.PlatformCode); // İlgili input alanına yazdırın
    $('#PlatformName').val(data.PlatformName); // İlgili input alanına yazdırın
});
