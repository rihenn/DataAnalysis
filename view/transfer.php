...
<head>
    ...
    <style>
        #BarcodepopupModal {
            z-index: 1056;
            /* Higher than the default 1050 for Bootstrap modals */
        }
        #PlatformAttributepopupModal {
            z-index: 1056;
            /* Higher than the default 1050 for Bootstrap modals */
        }
...
<body>
    ...
    <div class="modal fade" id="PlatformAttributepopupModal" tabindex="-1" aria-labelledby="popupModalLabel" aria-hidden="true">
        <div class="modal-dialog" style="--bs-modal-width: 50% !important">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-striped" id="cdPlatformAttributeTable" style="width:100% !important"></table>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="PlatformTypeAddpopupModal" tabindex="-1" aria-labelledby="popupModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="popupModalLabel">Platform Type Attribute</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
    ...
    <div class="modal fade" id="PlatformAddpopupModal" tabindex="-1" aria-labelledby="popupModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" style="--bs-modal-width: 40% !important">
            <div class="modal-content ">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <table id="PlatformTypeDatatable" class="table"></table>
                    <form id="PlatformForm">
                        <div class="mb-3">
                            <label for="PlatformCode" class="form-label">Platform Kodu</label>
                            <input type="text" class="form-control" id="PlatformCode" name="PlatformCode" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="PlatformName" class="form-label">Platform Adı</label>
                            <input type="text" class="form-control" id="PlatformName" name="PlatformName" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="ContentCode" class="form-label">İçerik Kodu</label>
                            <input type="text" class="form-control" id="ContentCode" name="ContentCode">
                        </div>
                        <div class="mb-3">
                            <label for="ContentName" class="form-label">İçerik Adı</label>
                            <input type="text" class="form-control" id="ContentName" name="ContentName">
                        </div>
                        <button class="btn btn-primary" id="PlatformDataAddBtn">Kaydet</button>
                    </form>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body">
                    <form id="insertForm">
                        ...
                        <div class="input-group">
                            <input id="PlatformCodeGet" type="text" class="form-control" placeholder="Platform Code"
                                aria-label="DataGetPlatformCodeBtn" aria-describedby="DataGetPlatformCodeBtn">
                            <button class="btn btn-outline-secondary" type="button" id="DataGetPlatformCodeBtn">...</button>
                        </div>
                        <input id="PlatformNameGet" class="border form-control mb-3" type="text" name="PlatformName" 
                            placeholder="Platform Name">
                        <input id="ContentCodeGet" class="border form-control mb-3" type="text" name="ContentCode"
                            placeholder="Content Code">
                        <input id="ContentNameGet" class="border form-control mb-3" type="text" name="ContentName"
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control editBarcode" id="editBarcode"
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control ColorCode" id="editColorCode"
                                        name="ColorCode">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="editItemDim1Code" class="form-label">Beden</label>
                                    <input type="text" class="form-control ItemDim1Code" id="editItemDim1Code"
                                        name="ItemDim1Code">
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control ColorCatalogDescription"
                                        id="editColorCatalogDescription" name="ColorCatalogDescription">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="editItemCostPrice" class="form-label">Ürün Maliyet Fiyatı</label>
                                    <input type="text" class="form-control ItemCostPrice" id="editItemCostPrice"
                                        name="ItemCostPrice">
                                </div>
                                <div class="col-md-3 mb-3">
    ...
    <section class="home">
        ...
        <div class="container ml-5">
            ...
            <button class="btn btn-primary" id="PlatformAttributeAddBtn">Platform Ekle</button>
            <button class="btn btn-primary" id="PlatformTypeAddBtn">Platform Özellik Ekle</button>
        </div>
    </section>
    ...
    <script>
        ...
        $("#PlatformAttributeAddBtn").on("click", function () {
            $("#PlatformAddpopupModal").modal("show")
        })
        $("#DataGetPlatformCodeBtn").on("click", function () {
            $("#PlatformAttributepopupModal").modal("show")
        })
    </script>
